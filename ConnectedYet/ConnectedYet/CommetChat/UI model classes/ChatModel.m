...
- (void)addSpecifiedItem:(NSMutableDictionary *)dic
{
    UUMessageFrame *messageFrame = [[UUMessageFrame alloc]init];
    UUMessage *message = [[UUMessage alloc] init];
    NSMutableDictionary *dataDic = [NSMutableDictionary dictionaryWithDictionary:dic];
    
    NSString *URLStr = [dic objectForKey:@"avtar"];
    [dataDic setObject:@1 forKey:@"from"];
    [dataDic setObject:[[NSDate date] description] forKey:@"strTime"];
    [dataDic setObject:[dic objectForKey:@"strName"] forKey:@"strName"];
    [dataDic setObject:URLStr forKey:@"strIcon"];
    if([[dic objectForKey:@"video"] length] != 0)
        [dataDic setObject:[dic objectForKey:@"video"] forKey:@"voice"];
