...
#define kFlatDatePickerButtonHeaderWidth 70  //44
...
#define kFlatDatePickerIconCancel @"button-large.png"
#define kFlatDatePickerIconValid @"button-large.png"
...
-(id)initWithFrame:(CGRect)frame {
    ...
    if ([super initWithFrame:frame]) {
        ...
        self.backgroundColorTitle = [UIColor colorWithRed:81.0/255.0 green:176.0/255.0 blue:180.0/255.0 alpha:1];//[UIColor colorWithRed:34.0/255.0 green:34.0/255.0 blue:34.0/255.0 alpha:1.0];
...
-(id)initWithParentView:(UIView*)parentView {
    ...
    if(IS_PHONE)
    {
        if ([self initWithFrame:CGRectMake(0.0, _parentView.frame.size.height, DEVICE_WIDTH, kFlatDatePickerHeight)])
        {
            _datePickerMode = FlatDatePickerModeDate;
    ...
    {
        if ([self initWithFrame:CGRectMake((DEVICE_WIDTH-500)/2, _parentView.frame.size.height, 500, kFlatDatePickerHeight)])
        {
            _datePickerMode = FlatDatePickerModeDate;
            [_parentView addSubview:self];
...
- (void)buildHeader {
    ...
    _buttonClose.backgroundColor = [UIColor colorWithRed:81.0/255.0 green:176.0/255.0 blue:180.0/255.0 alpha:1];
    
    //[_buttonClose setImage:[UIImage imageNamed:kFlatDatePickerIconCancel] forState:UIControlStateNormal];
    [_buttonClose setBackgroundImage:[UIImage imageNamed:kFlatDatePickerIconCancel] forState:UIControlStateNormal];
    [_buttonClose setTitle:@"Cancel" forState:UIControlStateNormal];
    ...
    _buttonValid.backgroundColor = [UIColor colorWithRed:81.0/255.0 green:176.0/255.0 blue:180.0/255.0 alpha:1];

    [_buttonValid setBackgroundImage:[UIImage imageNamed:kFlatDatePickerIconValid] forState:UIControlStateNormal];
    [_buttonValid setTitle:@"Done" forState:UIControlStateNormal];
    ...
    // Label Title
    _labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(kFlatDatePickerButtonHeaderWidth, 0.0, self.frame.size.width - (kFlatDatePickerButtonHeaderWidth * 2), kFlatDatePickerHeaderHeight)];
    
    _labelTitle.backgroundColor = [UIColor colorWithRed:81.0/255.0 green:176.0/255.0 blue:180.0/255.0 alpha:1];//kFlatDatePickerBackgroundColorTitle;
